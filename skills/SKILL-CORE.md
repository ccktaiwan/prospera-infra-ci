...
## 19. 給 Claude Code 的行為規則

**MUST NOT：** 指令裡不可包含詢問句或選項（Do you want to proceed? / y/n）
**MUST NOT：** 指令裡不可有說明文字和指令混合
**MUST：** 純指令，從第一行到 Write-Host [DONE] 一次完整
**MUST：** 遇到需要確認的操作，直接執行最安全的選項

---

*v1.6 · 2026-05-21 · prospera-ci-shared/skills/ · Kevin Chang（張淳嘉）*
